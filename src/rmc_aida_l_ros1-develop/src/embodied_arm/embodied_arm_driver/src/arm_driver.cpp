...
void SetHandPosture_Callback(const embodied_arm_msgs::Hand_Posture msg)
{
...
void SetHandSeq_Callback(const embodied_arm_msgs::Hand_Seq msg)
{
...
void SetHandSpeed_Callback(const embodied_arm_msgs::Hand_Speed msg)
{
...
void HandFollowPos_Callback(const embodied_arm_msgs::Hand_Angle msg)
{
    int res = 0;
    int i = 0;
...
void HandFollowAngle_Callback(const embodied_arm_msgs::Hand_Angle msg)
{
    int res = 0;
    int i = 0;
    int16_t hand_angle[6];
...
void SetHandForce_Callback(const embodied_arm_msgs::Hand_Force msg)
{
...
void SetHandAngle_Callback(const embodied_arm_msgs::Hand_Angle msg)
{
    int res = 0;
    int i = 0;
    int16_t hand_angle[6];
...
void SetJointStep_Callback(const embodied_arm_msgs::Joint_Step msg)
{
    int res = 0;
    uint8_t num;
    float angle;
...
void LiftHeightCtr_Callback(const embodied_arm_msgs::Lift_Height msg)
{
...
void LiftSpeedCtr_Callback(const embodied_arm_msgs::Lift_Speed msg)
{
...
void MoveJ_Callback(const embodied_arm_msgs::MoveJ msg)
{
    int res = 0;
    int i = 0;
...
void MoveL_Callback(const embodied_arm_msgs::MoveL msg)
{
    int res = 0;
    u_int8_t trajectory_connect = msg.trajectory_connect;
    byte speed;
...
void MoveC_Callback(const embodied_arm_msgs::MoveC msg)
{
    int res = 0;
    u_int8_t trajectory_connect = msg.trajectory_connect;
    uint16_t speed;
...
void JointTeach_Callback(const embodied_arm_msgs::Joint_Teach msg)
{
...
void PosTeach_Callback(const embodied_arm_msgs::Pos_Teach msg)
{
...
void OrtTeach_Callback(const embodied_arm_msgs::Ort_Teach msg)
{
...
void StopTeach_Callback(const embodied_arm_msgs::Stop_Teach msg)
{
 ...
 * *********************************************************************************/
void MoveJ_P_Callback(const embodied_arm_msgs::MoveJ_P msg)
{
    int res = 0;
...
void ChangeToolName_Callback(const embodied_arm_msgs::ChangeTool_Name msg)
{
    int res = 0;
...
void ChangeWorkFrame_Callback(const embodied_arm_msgs::ChangeWorkFrame_Name msg)
{
    int res = 0;
...
void GetArmState_Callback(const embodied_arm_msgs::GetArmState_Command msg)
{
    int res = 0;
 ...
 * *********************************************************************************/
//开始复合模式拖动示教
void StartMultiDragTeach_Callback(const embodied_arm_msgs::Start_Multi_Drag_Teach msg)
{
...
//力位混合控制
void SetForcePosition_Callback(const embodied_arm_msgs::Set_Force_Position msg)
{
    int res = 0;
...
//位姿透传力位混合补偿
void ForcePositionMovePose_Callback(const embodied_arm_msgs::Force_Position_Move_Pose msg)
{
    int res = 0;
    POSE target;
    target = Quater_To_Euler(msg.Pose);
...
//自定义模式位姿透传力位混合补偿
void ForcePositionMovePoseCustom_Callback(const embodied_arm_msgs::Force_Position_Move_Pose_Custom msg)
{
    int res = 0;
    POSE target;
    target = Quater_To_Euler(msg.Pose);
...
//角度透传力位混合补偿
void ForcePositionMoveJiont_Callback(const embodied_arm_msgs::Force_Position_Move_Joint msg)
{
    int res = 0;
    float joint[7];
...
void ManualSetForcePose_Callback(const embodied_arm_msgs::Manual_Set_Force_Pose msg)
{
...
void JointPos_Callback(const embodied_arm_msgs::JointPos msg)
{
    int res = 0;
    int i = 0;
    float joint[7];
...
void MoveJ_Fd_Custom_Callback(const embodied_arm_msgs::JointPosCustom msg)
{
    int res = 0;
    int i = 0;
    float joint[7];
...
void Arm_DO_Callback(const embodied_arm_msgs::Arm_Digital_Output msg)
{
    int res = 0;
...
void Arm_AO_Callback(const embodied_arm_msgs::Arm_Analog_Output msg)
{
    int res = 0;
    if ((msg.num > 0) && (msg.num < 5))
    {
...
void Tool_DO_Callback(const embodied_arm_msgs::Tool_Digital_Output msg)
{
    int res = 0;
...
void Tool_AO_Callback(const embodied_arm_msgs::Tool_Analog_Output msg)
{
    int res = 0;
...
void Gripper_Pick_Callback(embodied_arm_msgs::Gripper_Pick msg)
{
    int res = 0;
...
void Gripper_Pick_On_Callback(embodied_arm_msgs::Gripper_Pick msg)
{
    int res = 0;
...
void Gripper_Set_Callback(embodied_arm_msgs::Gripper_Set msg)
{
    int res = 0;
...
void Joint_Enable_Callback(const embodied_arm_msgs::Joint_Enable msg)
{
    int res = 0;
...
void IO_Update_Callback(const embodied_arm_msgs::IO_Update msg)
{
    int res = 0;
    // Arm IO Update
    if (msg.type == 1)
 ...
 * *********************************************************************************/
void TurtleCtr_Callback(const embodied_arm_msgs::Turtle_Driver msg)
{
...
void Movep_Fd_Callback(const embodied_arm_msgs::CartePos msg)
{
...
void Movep_Fd_Custom_Callback(const embodied_arm_msgs::CartePosCustom msg)
{
    // ROS_INFO("enter Movep_Fd_Callback");
    int res = 0;
    byte speed;
...
/*****************************设置Udp参数配置***************************/
void Set_Realtime_Push_callback(const embodied_arm_msgs::Set_Realtime_Push msg)
{
    int res = 0;
    uint16_t cycle;
    bool enable;
...
void Set_Modbus_Mode_Callback(const embodied_arm_msgs::Set_Modbus_Mode msg)
{
    int res = 0;
...
void Set_Modbustcp_Mode_Callback(const embodied_arm_msgs::Set_Modbus_Mode msg)
{
    int res = 0;
...
/***************************Modbus Infomation Read/Write function******************/
void Read_Coils_Callback(const embodied_arm_msgs::Read_Register msg)
{
...
void Read_Multiple_Coils_Callback(const embodied_arm_msgs::Read_Register msg)
{
...
void Write_Single_Coil_Callback(const embodied_arm_msgs::Write_Register msg)
{
    int res=0;  
    if(msg.data.size() == 1)
    {
...
void Write_Coils_Callback(const embodied_arm_msgs::Write_Register msg)
{
    int res=0;
...
void Read_Input_Status_Callback(const embodied_arm_msgs::Read_Register msg)
{
...
void Read_Holding_Registers_Callback(const embodied_arm_msgs::Read_Register msg)
{
...
void Write_Single_Register_Callback(const embodied_arm_msgs::Write_Register msg)
{
    int res=0;
    if(msg.data.size() == 1)
    {
...
void Write_Registers_Callback(const embodied_arm_msgs::Write_Register msg)
{
    int res=0;
...
void Read_Multiple_Holding_Registers_Callback(const embodied_arm_msgs::Read_Register msg)
{
...
void Read_Input_Registers_Callback(const embodied_arm_msgs::Read_Register msg)
{
...
void Read_Multiple_Input_Registers_Callback(const embodied_arm_msgs::Read_Register msg)
{
...
int main(int argc, char **argv)
{
    ...
    // msg
    embodied_arm_msgs::Arm_IO_State Arm_IO;
    embodied_arm_msgs::Tool_IO_State Tool_IO;
    embodied_arm_msgs::Plan_State Plan;
    embodied_arm_msgs::ChangeTool_State ChangeTool_State;
    embodied_arm_msgs::ChangeWorkFrame_State ChangeWorkFrame_State;
    embodied_arm_msgs::Arm_Current_State Arm_State;
    embodied_arm_msgs::Force_Position_State Force_Position_State;
    embodied_arm_msgs::Six_Force Six_Force;
    embodied_arm_msgs::Six_Force zero_force;
    embodied_arm_msgs::Six_Force work_zero_force;
    embodied_arm_msgs::Six_Force tool_zero_force;
    std_msgs::Bool state;
    std_msgs::UInt32 plus_mode_result;
    std_msgs::UInt16 plus_touch_result;
    embodied_arm_msgs::Joint_Current joint_current;
    embodied_arm_msgs::ArmState armState;
    embodied_arm_msgs::LiftState liftState;
    embodied_arm_msgs::Arm_Software_Version arm_version;

    /***********************************UDP控制数据类型*************************************/ 
    embodied_arm_msgs::Set_Realtime_Push udp_set_realtime_push;
    ...
    private_nh_.getParam("arm_joints", arm_joints); // 加载 arm_joints 参数
    int dof = arm_joints.size();
    if (dof == 6 || dof == 7) {
        real_joint.name.resize(dof);
        real_joint.position.resize(dof);
        udp_real_joint.name.resize(dof);
        udp_real_joint.position.resize(dof);
        for (int i = 0; i < dof; i++) {
            real_joint.name[i] = arm_joints[i];
            udp_real_joint.name[i] = arm_joints[i];
        }
        armState.joint.resize(dof);
        Arm_State.joint.resize(dof);
        joint_current.joint_current.resize(dof);
        udp_joint_error_code.joint.resize(dof);
        udp_joint_current.joint_current.resize(dof);
        udp_joint_en_flag.joint_en_flag.resize(dof);
        udp_joint_speed.joint_speed.resize(dof);
        udp_joint_temperature.joint_temperature.resize(dof);
        udp_joint_voltage.joint_voltage.resize(dof);
    } else {
        ROS_ERROR("Invalid arm_joints size: %d, expected 6 or 7", dof);
    }
    /***** ********************************END****************************************/
    ...
    pub_getControllerRS485Mode_result = nh_.advertise<embodied_arm_msgs::RS485_Mode>("rm_driver/Get_Controller_RS485_Mode_Result",10);
    sub_getToolRS485Mode = nh_.subscribe("rm_driver/Get_Tool_RS485_Mode", 10, Get_Tool_RS485_Mode_Callback);
    pub_getToolRS485Mode_result = nh_.advertise<embodied_arm_msgs::RS485_Mode>("rm_driver/Get_Tool_RS485_Mode_Result",10);
    ...
    pub_readCoils_result = nh_.advertise<embodied_arm_msgs::Register_Data>("rm_driver/Read_Coils_Result",10);
    sub_readMultipleCoils = nh_.subscribe("rm_driver/Read_Multiple_Coils", 10, Read_Multiple_Coils_Callback);
    pub_readMultipleCoils_result = nh_.advertise<embodied_arm_msgs::Register_Data>("rm_driver/Read_Multiple_Coils_Result",10);
    ...
    pub_readInputStatus_result = nh_.advertise<embodied_arm_msgs::Register_Data>("rm_driver/Read_Input_Status_Result",10);
    sub_readHoldingRegisters = nh_.subscribe("rm_driver/Read_Holding_Registers", 10, Read_Holding_Registers_Callback);
    pub_readHoldingRegisters_result = nh_.advertise<embodied_arm_msgs::Register_Data>("rm_driver/Read_Holding_Registers_Result",10);
    ...
    pub_readMultipleHoldingRegisters_result = nh_.advertise<embodied_arm_msgs::Register_Data>("rm_driver/Read_Multiple_Holding_Registers_Result",10);
    sub_readInputRegisters = nh_.subscribe("rm_driver/Read_Input_Registers", 10, Read_Input_Registers_Callback);
    pub_readInputRegisters_result = nh_.advertise<embodied_arm_msgs::Register_Data>("rm_driver/Read_Input_Registers_Result",10);
    ...
    pub_readMultipleInputRegisters_result = nh_.advertise<embodied_arm_msgs::Register_Data>("rm_driver/Read_Multiple_Input_Registers_Result",10);
    ...
    Get_Arm_Software_Version_Result = nh_.advertise<embodied_arm_msgs::Arm_Software_Version>("rm_driver/Get_Arm_Software_Version_Result", 10);
    /********************************************udp配置参数修改控制********************************************/
    ...
    Get_Realtime_Push_Result = nh_.advertise<embodied_arm_msgs::Set_Realtime_Push>("rm_driver/Get_Realtime_Push_Result", 10);
    /********************************************力传感器外力数据********************************************/
    ...
    pub_UdpError = nh_.advertise<embodied_arm_msgs::Err>("rm_driver/Error", 100);
    pub_JointErrorCode = nh_.advertise<embodied_arm_msgs::Manual_Set_Force_Pose>("rm_driver/JointErrorCode", 100);
    /*****************************************发布当前的受力基准坐标系*******************************************/
    ...
    // publisher
    ChangeTool_Name = nh_.advertise<embodied_arm_msgs::ChangeTool_State>("rm_driver/ChangeTool_State", 10);
    ChangeWorkFrame_Name = nh_.advertise<embodied_arm_msgs::ChangeWorkFrame_State>("rm_driver/ChangeWorkFrame_State", 10);
    ArmCurrentState = nh_.advertise<embodied_arm_msgs::Arm_Current_State>("rm_driver/Arm_Current_State", 10);
    pub_armCurrentState = nh_.advertise<embodied_arm_msgs::ArmState>("rm_driver/ArmCurrentState", 10);
    ...
    pub_Force_Position_State = nh_.advertise<embodied_arm_msgs::Force_Position_State>("rm_driver/Force_Position_State", 10);
    ...
    Arm_IO_State = nh_.advertise<embodied_arm_msgs::Arm_IO_State>("rm_driver/Arm_IO_State", 10);
    Tool_IO_State = nh_.advertise<embodied_arm_msgs::Tool_IO_State>("rm_driver/Tool_IO_State", 10);
    Plan_State = nh_.advertise<embodied_arm_msgs::Plan_State>("rm_driver/Plan_State", 10);
    pub_PoseState = nh_.advertise<geometry_msgs::Pose>("rm_driver/Pose_State", 10);
    pub_HandStatus = nh_.advertise<embodied_arm_msgs::Hand_Status>("rm_driver/Udp_Hand_Status", 1);
    pub_RmPlusState = nh_.advertise<embodied_arm_msgs::Rm_Plus_State>("rm_driver/Udp_Plus_State", 1);
    pub_RmPlusBase = nh_.advertise<embodied_arm_msgs::Rm_Plus_Base>("rm_driver/Udp_Plus_Base", 1);
    pub_currentJointCurrent = nh_.advertise<embodied_arm_msgs::Joint_Current>("rm_driver/Joint_Current", 10);
    pub_liftState = nh_.advertise<embodied_arm_msgs::LiftState>("rm_driver/LiftState", 10);
    pub_setGripperResult = nh_.advertise<std_msgs::Bool>("rm_driver/Set_Gripper_Result", 10);

    pub_ArmCurrentStatus = nh_.advertise<embodied_arm_msgs::Arm_Current_Status>("rm_driver/Udp_Arm_Current_status",10);
    pub_JointCurrent = nh_.advertise<embodied_arm_msgs::Joint_Current>("rm_driver/Udp_Joint_Current",10);
    pub_JointEnFlag = nh_.advertise<embodied_arm_msgs::Joint_En_Flag>("rm_driver/Udp_Joint_En_Flag",10);
    pub_JointSpeed = nh_.advertise<embodied_arm_msgs::Joint_Speed>("rm_driver/Udp_Joint_Speed",10);
    pub_JointTemperature = nh_.advertise<embodied_arm_msgs::Joint_Temperature>("rm_driver/Udp_Joint_Temperature",10);
    pub_JointVoltage = nh_.advertise<embodied_arm_msgs::Joint_Voltage>("rm_driver/Udp_Joint_Voltage",10);
    pub_PoseEuler = nh_.advertise<embodied_arm_msgs::Joint_PoseEuler>("rm_driver/Udp_Joint_PoseEuler",10);
    pub_LiftInPosition = nh_.advertise<embodied_arm_msgs::Lift_In_Position>("rm_driver/Lift_InPosition",10);
    /******************************************************************************************/
    ...
    /*************************************六维力数据发布（非UDP）*******************************************/
    pub_GetSixForce = nh_.advertise<embodied_arm_msgs::Six_Force>("rm_driver/GetSixForce", 100);
    pub_SixZeroForce = nh_.advertise<embodied_arm_msgs::Six_Force>("rm_driver/SixZeroForce", 100);
    pub_Work_Zero_Force = nh_.advertise<embodied_arm_msgs::Six_Force>("rm_driver/WorkZeroForce", 100);
    pub_Tool_Zero_Force = nh_.advertise<embodied_arm_msgs::Six_Force>("rm_driver/ToolZeroForce", 100);
    /*************************************六维力数据发布（UDP）*******************************************/
    pub_UdpSixForce = nh_.advertise<embodied_arm_msgs::Six_Force>("rm_driver/UdpSixForce", 100);
    pub_UdpSixZeroForce = nh_.advertise<embodied_arm_msgs::Six_Force>("rm_driver/UdpSixZeroForce", 100);
    /*************************************设置末端生态协议模式*******************************************/
